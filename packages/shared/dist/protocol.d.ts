...
export type ErrorCode = 'ROOM_NOT_FOUND' | 'ROOM_FULL' | 'BANNED' | 'NOT_YOUR_TURN' | 'ILLEGAL_ACTION' | 'NOT_HOST' | 'GAME_IN_PROGRESS' | 'SEAT_TAKEN' | 'INVALID_PAYLOAD' | 'DUPLICATE_ACTION';
